"""nosleguma_uzdevums URL Configuration
...
urlpatterns = [
    ...
    path('add-student', uzdevumi.views.add_student),
    path('student/<int:student_id>', uzdevumi.views.get_student, name='get-student'),
    path('', uzdevumi.views.get_all_students),
    path('filter-students/student', uzdevumi.views.filter_group_by_students),
]